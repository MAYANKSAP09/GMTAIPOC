...
os.environ["BROWSER_GATHER_USAGE_STATS"] = os.getenv("BROWSER_GATHER_USAGE_STATS")
print(os.environ["AICORE_AUTH_URL"])
...
text_splitter = CharacterTextSplitter(chunk_size=50000, chunk_overlap=50)
...
db = HanaDB(
    embedding=embeddings, connection=connection, table_name="TEST"
)
